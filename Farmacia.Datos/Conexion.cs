...
namespace DAL
{
    public class Conexion
    {
        ...
        {   // HACK: Cadena de conexión hardcodeada. Luego ponerla como parametro de configuración del proyecto u otra alternativa.
            strCadenaDeConexion = @"Data Source=DESKTOP-P21NUQ6\SQLEXPRESS;Initial Catalog=FarmaciaBBDD;Integrated Security=True";
        ...
        public int EscribirPorComando(string pTexto, SqlParameter[] pParametrosSql)
        {
            ...
            try
            {
                SqlCommand objComando = new SqlCommand(pTexto, objConexion);
                objComando.CommandType = CommandType.Text;
        ...
        //sobrecarga
        public DataTable LeerPorComando(string pComando, SqlParameter[] pParametrosSql)
        {
            var unaTabla = new DataTable();
            this.Conectar();
            ...
            try
            {
                SqlCommand objComando = new SqlCommand(pComando, objConexion);
                objComando.CommandType = CommandType.Text;
